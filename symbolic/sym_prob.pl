...
0.3::action(data_augmentation,overfitting):- problem(overfitting).
0.3::action(decr_lr,underfitting):- problem(underfitting).
0.3::action(inc_neurons,underfitting):- problem(underfitting).
0.45::action(new_fc_layer,underfitting):- problem(underfitting).
0.75::action(new_conv_layer,underfitting):- problem(underfitting).
